...
export function SettingsForm() {
  ...
  const { settings, setMode, setTheme, setLanguage, setWorkGoals, setIsAdmin, timerIsActive, updateSettings } = useSettings();
              ...
              <AlertDialogContent>
                ...
                <AlertDialogFooter>
                  ...
                  <AlertDialogAction
                    ...
                    disabled={!deletePassword || isDeleteDialogSubmitting}
                    className="bg-destructive hover:bg-destructive/90"
                  >
                    {isDeleteDialogSubmitting ? t('deleting') : t('confirmDelete')}
                  </AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
            </AlertDialog>
