...
const translations: Record<Language, Translations> = {
  en: {
    ...
    error: "Error",
    errorEnterOrgName: "Please enter an organization name.",
    orgCreated: "Organization Created",
    orgCreatedDesc: "is ready.",
    orgCreatedError: "Failed to create organization.",
    serialCopied: "Serial Number Copied",
    serialCopiedDesc: "The organization serial number has been copied to your clipboard.",
    shareLinkCopied: "Share Link Copied",
    shareLinkCopiedDesc: "The invitation link has been copied to your clipboard.",
    orgNameUpdated: "Organization Name Updated",
    orgNameUpdatedDesc: "Organization name changed to",
    orgSaveError: "Failed to save organization.",
    orgDeleted: "Organization Deleted",
    orgDeletedDesc: "The organization and all associated employee links have been removed.",
    orgDeleteFailed: "Deletion Failed",
    orgDeleteFailedDesc: "Could not delete the organization.",
    ...
    employeeLearningOverview: "Employee Learning Overview",
    topTopic: "Top Topic",
    hoursLearned: "h learned",
    successRate: "% success rate",
    topLearners: "Top Learners",
    none: "None",
    unknownUser: "Unknown User",
    createYourOrg: "Create Your Organization",
    createYourOrgDesc: "Give your organization a name to get started. You can invite employees after creation.",
    orgName: "Organization Name",
    orgNamePlaceholder: "e.g., My Awesome Company",
    creatingOrg: "Creating...",
    createOrg: "Create Organization",
    orgManagement: "Organization Management",
    orgManagementDesc: "Manage your organization settings and serial number.",
    saving: "Saving...",
    saveName: "Save Name",
    orgSerialNumber: "Organization Serial Number",
    shareLinkDesc: "Share this link with employees to have them join your organization.",
    deleting: "Deleting...",
    deleteOrg: "Delete Organization",
    deleteOrgConfirmation: "This action cannot be undone. This will permanently delete the organization. Employee time data will remain, but the organization link will be broken.",
    confirmDeleteOrg: "Yes, delete organization",
    
    // Organization Joining
    orgJoined: "Organization Joined",
    orgJoinedDesc: "You have successfully joined",
    orgRemoved: "Organization Update",
    orgRemovedDesc: "You have been removed from the organization:",
...
history: "Verlauf",
    ...
    adminPanel: "Admin-Panel",
    error: "Fehler",
    errorEnterOrgName: "Bitte geben Sie einen Organisationsnamen ein.",
    orgCreated: "Organisation erstellt",
    orgCreatedDesc: "ist bereit.",
    orgCreatedError: "Organisation konnte nicht erstellt werden.",
    serialCopied: "Seriennummer kopiert",
    serialCopiedDesc: "Die Seriennummer der Organisation wurde in Ihre Zwischenablage kopiert.",
    shareLinkCopied: "Einladungslink kopiert",
    shareLinkCopiedDesc: "Der Einladungslink wurde in Ihre Zwischenablage kopiert.",
    orgNameUpdated: "Organisationsname aktualisiert",
    orgNameUpdatedDesc: "Organisationsname geändert zu",
    orgSaveError: "Organisation konnte nicht gespeichert werden.",
    orgDeleted: "Organisation gelöscht",
    orgDeletedDesc: "Die Organisation und alle zugehörigen Mitarbeiterverknüpfungen wurden entfernt.",
    orgDeleteFailed: "Löschen fehlgeschlagen",
    orgDeleteFailedDesc: "Die Organisation konnte nicht gelöscht werden.",
    totalEmployees: "Mitarbeiter gesamt",
    avgHours: "Ø Std./Woche",
    avgEfficiency: "Ø Effizienz",
    employeeOverview: "Mitarbeiterübersicht",
    noEmployeesFound: "Keine Mitarbeiter gefunden.",
    lastActive: "Zuletzt aktiv",
    hoursTotal: "h gesamt",
    efficiencyPercentage: "% Effizienz",
    topPerformers: "Top-Performer",
    needsAttention: "Benötigt Aufmerksamkeit",
    never: "Niemals",
    totalLearningHours: "Lernstunden gesamt",
    avgSuccessRate: "Ø Erfolgsquote",
    totalSessions: "Sitzungen gesamt",
    topTopics: "Top-Themen",
    employeeLearningOverview: "Mitarbeiter-Lernübersicht",
    topTopic: "Top-Thema",
    hoursLearned: "h gelernt",
    successRate: "% Erfolgsquote",
    topLearners: "Top-Lernende",
    none: "Keine",
    unknownUser: "Unbekannter Benutzer",
    createYourOrg: "Erstellen Sie Ihre Organisation",
    createYourOrgDesc: "Geben Sie Ihrer Organisation einen Namen, um loszulegen. Sie können nach der Erstellung Mitarbeiter einladen.",
    orgName: "Organisationsname",
    orgNamePlaceholder: "z.B. Meine Tolle Firma",
    creatingOrg: "Wird erstellt...",
    createOrg: "Organisation erstellen",
    orgManagement: "Organisationsverwaltung",
    orgManagementDesc: "Verwalten Sie Ihre Organisationseinstellungen und die Seriennummer.",
    saving: "Speichern...",
    saveName: "Namen speichern",
    orgSerialNumber: "Seriennummer der Organisation",
    shareLinkDesc: "Teilen Sie diesen Link mit Mitarbeitern, damit sie Ihrer Organisation beitreten können.",
    deleting: "Wird gelöscht...",
    deleteOrg: "Organisation löschen",
    deleteOrgConfirmation: "Diese Aktion kann nicht rückgängig gemacht werden. Dadurch wird die Organisation dauerhaft gelöscht. Zeitdaten der Mitarbeiter bleiben erhalten, aber die Verknüpfung zur Organisation wird aufgehoben.",
    confirmDeleteOrg: "Ja, Organisation löschen",
    
    // Organization Joining
    orgJoined: "Organisation beigetreten",
    orgJoinedDesc: "Sie sind erfolgreich der Organisation beigetreten:",
    orgRemoved: "Organisations-Update",
    orgRemovedDesc: "Sie wurden aus der Organisation entfernt:",
  },
};
